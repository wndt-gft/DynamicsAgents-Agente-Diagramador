...
try:
    from agents.diagramador.app.settings import get_metamodel_path, get_template_directory
...
class MetamodelValidator:
    ...
    def _get_default_metamodel_path(self) -> str:
        ...
        try:
            ...
            return str(get_metamodel_path(template_dir))
        except Exception:
            base = Path(__file__).resolve()
            candidate = (base.parents[4] / 'templates' / 'C4-Model' / 'metamodel.xml').resolve()
